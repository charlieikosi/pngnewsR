#' National News Scraper (The National News Paper)
#' 
#' Scrapes national news articles from the National News website
...
national_na <- function(pages){
  ...
  url <- "https://www.thenational.com.pg/category/national/"
